...
print("Categorical Variables: ", categorical(weather))
print("Numerical Variables: ", numerical(weather))
print("*"*50)
...
print("Clear Weather Count: ", clear(weather,"Weather",'Clear'))
print("Wind Speed 4 km/h Count: ",clear(weather,"Wind Spd (km/h)", 4))
print("*"*50)
...
print(wind_speed_35_vis_25.head(2))
print("*"*50)
...
weather_fahrenheit = convert(weather,"Temp (C)")
